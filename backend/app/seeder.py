...
async def seed_data():
    ...
    async with async_session_factory() as session:
        ...
        settings_to_seed = [
            ("meal_window_breakfast_start", "07:15", "Breakfast start time (Mon-Fri)"),
            ("meal_window_breakfast_end", "08:30", "Breakfast end time (Mon-Fri)"),
            ("meal_window_lunch_start", "12:15", "Lunch start time (Mon-Fri)"),
            ("meal_window_lunch_end", "13:45", "Lunch end time (Mon-Fri)"),
            ("meal_window_dinner_start", "19:45", "Dinner start time (Mon-Fri)"),
            ("meal_window_dinner_end", "20:45", "Dinner end time (Mon-Fri)"),
            ("meal_window_breakfast_start_weekend", "08:30", "Breakfast start time (Sat/Sun)"),
            ("meal_window_breakfast_end_weekend", "09:30", "Breakfast end time (Sat/Sun)"),
            ("meal_window_lunch_start_weekend", "13:00", "Lunch start time (Sat/Sun)"),
            ("meal_window_lunch_end_weekend", "14:00", "Lunch end time (Sat/Sun)"),
            ("meal_window_dinner_start_weekend", "19:45", "Dinner start time (Sat/Sun)"),
            ("meal_window_dinner_end_weekend", "20:45", "Dinner end time (Sat/Sun)"),
