"""Seed script to populate initial demo data (students, admin, super-admin, meal selections, holidays) in the backend."""
import asyncio
import uuid
...
async def seed_data():
    ...
    async with async_session_factory() as session:
        ...
        settings_to_seed = [
            ...
            ("selection_cutoff_time", "20:30", "Selection cutoff time"),
        ...
        if not student_user:
            ...
            session.add(profile)
            print("[SEED] Created student: TEST001 / password123")
        ...
        if not lakeside_user:
            ...
            print("[SEED] Created Lakeside student: LAKESIDE001 / password123")
        else:
            lakeside_user.password_hash = hash_password("password123")
            lakeside_user.account_status = AccountStatus.ACTIVE.value
            print("[SEED] Updated Lakeside student LAKESIDE001 password to password123")
        ...
        if not admin_user:
            ...
            print("[SEED] Created admin: ADMIN001 / password123")
        else:
            admin_user.password_hash = hash_password("password123")
            print("[SEED] Updated admin ADMIN001 password to password123")
        ...
        if not sadmin_user:
            ...
            print("[SEED] Created super admin: SADMIN001 / password123")
